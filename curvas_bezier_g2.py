...
def bezier_quadratica(p0, p1, p2, num_points=100):
    pontos = []
...
def executar_brezier():
    try:
        ...
        # Calcular a curva de Bézier
        pontos = bezier_quadratica(p0, p1, p2)
...
janela = tk.Tk()
janela.title("Curva de Bézier de Grau 2 - Malha de Pixels")
...
botao_executar = tk.Button(janela, text="Desenhar Curva de Bézier", command=executar_brezier)
botao_executar.grid(row=6, column=1, columnspan=2, padx=10, pady=10)
